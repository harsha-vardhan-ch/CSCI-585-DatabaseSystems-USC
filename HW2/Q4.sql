...
select count(*) from ( select distinct(emp_id) as number_of_employees_self_reported_symptoms from symptom where reported_date between '05-SEP-2021' and '10-SEP-2021' group by emp_id);
